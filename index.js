...
const courseInformationByCourseId = {
  ...
  MATH204: {
    ...
    coreqs: [],
    information:
      "Algebra and geometry of vectors, dot and cross products, lines and planes. System of equations, operations on matrices, rank, inverse, quadratic form, and rotation of axes.",
  },
  COMP346: {
...
function setup() {
  ...
  let xOffset = 0;
  let yOffset = 0;
  const rootElementBounds = document
    .getElementById("root-svg")
